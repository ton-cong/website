...
public class ProductController {
    ...
    @GetMapping("/search")
    @Operation(summary = "Search & filter products", description = "Public endpoint. Supports keyword, category, brand, cpu, ram, storage, price range.")
    public Page<ProductResponse> searchProducts(
        ...
        return productService.searchProducts(keyword, categoryId, brand, cpu, ram, storage, minPrice, maxPrice, page, size, sortBy, sortDir);
    }

    @GetMapping("/filter-options")
    @Operation(summary = "Get distinct filter values", description = "Public endpoint. Returns distinct brands.")
    public java.util.Map<String, Object> getFilterOptions() {
        java.util.Map<String, Object> options = new java.util.HashMap<>();
        options.put("brands", productService.getDistinctBrands());
        return options;
    }
}
